  ...
  "propComponents": [
    {
      ...
      "props": [
        ...
        },
        {
          ...
          "type": "string | ((email: string) => boolean)",
        ...
        {
          "name": "onReportABug",
          "type": "string | ((email:string, bug: string) => boolean)",
        ...
        },
        {
          ...
          "type": "string | ((email:string, feedback: string) => boolean)",
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["URL Example"])}
    {React.createElement(pageData.examples["Advanced feedback modal"])}
    {React.createElement(pageData.examples["Advanced with email passed to modal"])}
